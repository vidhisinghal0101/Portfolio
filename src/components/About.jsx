...
const skills = [
  ...
  'MySQL', 'MongoDB', 'Generative AI', 'Data Structures & Algorithms'
];
      ...
      <div className="container about-content">
        <div className="about-text-container">
          ...
          <div className="resume-section">
            ...
            <div className="resume-item">
              <h4>AI & ML Intern</h4>
              <p className="resume-meta">Earth5R | Aug 2024</p>
              <p className="resume-desc">Hands-on internship focusing on AI and ML applications for environmental solutions, developing intelligent models and analyzing data to support sustainability.</p>
            </div>
            <div className="resume-item">
