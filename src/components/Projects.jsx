...
const projectsData = [
  ...
  },
  {
    id: 2,
    title: 'DawnBox',
    tech: 'Next.js | FastAPI | LangGraph | Google Gemini AI | Tailwind CSS | Zustand | Python | JavaScript',
    description: 'DawnBox is a Developer Unified Intelligence Dashboard that connects to tools like GitHub and Gmail to summarize and prioritize notifications using LangGraph agents and Gemini AI.',
    image: dawnboxImg,
    links: [
