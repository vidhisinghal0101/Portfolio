...
const projectsData = [
  {
    ...
    description: 'Built and deployed a full-stack finance app with React (Vercel), Express (Render), and PostgreSQL (Neon). Implemented JWT authentication, role-based access control, and transaction CRUD with filtering, search, and pagination. Built interactive analytics dashboards using Recharts with budget tracking and visual spending alerts.',
  ...
  },
  {
    ...
    description: 'Built and deployed a full-stack developer productivity app aggregating GitHub and Gmail notifications into a unified AI-curated feed. Designed a multi-step LangGraph pipeline using Groq\'s Llama 3.1 to score urgency, assign action tags, and generate morning briefings. Implemented JWT auth with FastAPI and async SQLAlchemy ORM for secure backend data handling.',
    image: dawnboxImg,
    links: [
